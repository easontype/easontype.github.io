# variant: balanced
# base: ./DESIGN.md (ds-reverse/ds-structure 產出的初版)
...
typography:
  font-display: "Space Grotesk, IBM Plex Sans TC, sans-serif"   # 標題/品牌字，幾何科技感
  font-sans:  "IBM Plex Sans TC, system-ui, sans-serif"          # 中文本文，長文可讀性優先
  font-mono:  "JetBrains Mono, ui-monospace"                     # 日期/標籤/code
